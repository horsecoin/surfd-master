...
/*
namespace surf { namespace plugin_tests {
...
SURF_DEFINE_PLUGIN( test, surf::plugin_tests::test_plugin )

FC_REFLECT( surf::plugin_tests::test_a_operation, (account) )
FC_REFLECT( surf::plugin_tests::test_b_operation, (account) )

DECLARE_OPERATION_TYPE( surf::plugin_tests::test_op );
FC_REFLECT_TYPENAME( surf::plugin_tests::test_op );
DEFINE_OPERATION_TYPE( surf::plugin_tests::test_op );
*/
