...
namespace surf {
   ...
   namespace protocol {
      ...
      #define SURF_INIT_PUBLIC_KEY (surf::protocol::public_key_type(SURF_INIT_PUBLIC_KEY_STR))
...
namespace fc
{
    void to_variant( const surf::protocol::public_key_type& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  surf::protocol::public_key_type& vo );
    void to_variant( const surf::protocol::extended_public_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, surf::protocol::extended_public_key_type& vo );
    void to_variant( const surf::protocol::extended_private_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, surf::protocol::extended_private_key_type& vo );
}

FC_REFLECT( surf::protocol::public_key_type, (key_data) )
FC_REFLECT( surf::protocol::public_key_type::binary_key, (data)(check) )
FC_REFLECT( surf::protocol::extended_public_key_type, (key_data) )
FC_REFLECT( surf::protocol::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( surf::protocol::extended_private_key_type, (key_data) )
FC_REFLECT( surf::protocol::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_TYPENAME( surf::protocol::share_type )

FC_REFLECT( surf::void_t, )
