#pragma once
#include <surf/protocol/base.hpp>
...
namespace surf { namespace protocol {
   ...
   {
      FC_ASSERT( permlink.size() < SURF_MAX_PERMLINK_LENGTH, "permlink is too long" );
   ...
   struct comment_options_operation : public base_operation
   {
      ...
      asset             max_accepted_payout    = asset( 1000000000, SURF_SYMBOL );       /// the maximum payout this post will receive
    ...
    * @ingroup operations
    *
    * @brief Transfers SURF from one account to another.
    */
   ...
   /**
    *  This operation converts SURF into VFS (Vesting Fund Shares) at
   ...
   {
      /**
       *  This fee, paid in SURF, is converted into VESTING SHARES for the new account. Accounts
       *  without vesting shares cannot earn usage rations and therefore are powerless. This minimum
       *  fee requires all accounts to have some kind of commitment to the network that includes the
       *  ability to vote and make transactions.
       */
      asset             account_creation_fee = asset( SURF_MIN_ACCOUNT_CREATION_FEE, SURF_SYMBOL );

      /**
       *  This witnesses vote for the maximum_block_size which is used by the network
       *  to tune rate limiting and capacity
       */
      uint32_t          maximum_block_size = SURF_MIN_BLOCK_SIZE_LIMIT * 2;

      void validate()const
      {
         FC_ASSERT( account_creation_fee.amount >= SURF_MIN_ACCOUNT_CREATION_FEE);
         FC_ASSERT( maximum_block_size >= SURF_MIN_BLOCK_SIZE_LIMIT);
      }
   };
...
FC_REFLECT( surf::protocol::chain_properties, (account_creation_fee)(maximum_block_size) );

FC_REFLECT( surf::protocol::account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( surf::protocol::account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( surf::protocol::account_update_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( surf::protocol::transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( surf::protocol::transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( surf::protocol::withdraw_vesting_operation, (account)(vesting_shares) )
FC_REFLECT( surf::protocol::set_withdraw_vesting_route_operation, (from_account)(to_account)(percent)(auto_vest) )
FC_REFLECT( surf::protocol::witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( surf::protocol::account_witness_vote_operation, (account)(witness)(approve) )
FC_REFLECT( surf::protocol::account_witness_proxy_operation, (account)(proxy) )
FC_REFLECT( surf::protocol::comment_operation, (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata) )
FC_REFLECT( surf::protocol::vote_operation, (voter)(author)(permlink)(weight) )
FC_REFLECT( surf::protocol::custom_operation, (required_auths)(id)(data) )
FC_REFLECT( surf::protocol::custom_json_operation, (required_auths)(required_posting_auths)(id)(json) )
FC_REFLECT( surf::protocol::custom_binary_operation, (required_owner_auths)(required_active_auths)(required_posting_auths)(required_auths)(id)(data) )

FC_REFLECT( surf::protocol::delete_comment_operation, (author)(permlink) );

FC_REFLECT( surf::protocol::beneficiary_route_type, (account)(weight) )
FC_REFLECT( surf::protocol::comment_payout_beneficiaries, (beneficiaries) )
