 ...
 * - Length is between (inclusive) SURF_MIN_ACCOUNT_NAME_LENGTH and SURF_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace surf::protocol


FC_REFLECT_TYPENAME( surf::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( surf::protocol::authority::key_authority_map)
FC_REFLECT( surf::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( surf::protocol::authority::classification, (owner)(active)(key)(posting) )
