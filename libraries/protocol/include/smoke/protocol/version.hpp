...
/*
 * This class represents the basic versioning scheme of the Surf blockchain.
...
{
   class variant;
   void to_variant( const surf::protocol::version& v, variant& var );
   void from_variant( const variant& var, surf::protocol::version& v );

   void to_variant( const surf::protocol::hardfork_version& hv, variant& var );
   void from_variant( const variant& var, surf::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( surf::protocol::version, (v_num) )
FC_REFLECT_DERIVED( surf::protocol::hardfork_version, (surf::protocol::version), )

FC_REFLECT( surf::protocol::hardfork_version_vote, (hf_version)(hf_time) )
