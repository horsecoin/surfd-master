...
/*namespace fc {
    void to_variant( const surf::protocol::operation& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  surf::protocol::operation& vo );
}*/

DECLARE_OPERATION_TYPE( surf::protocol::operation )
FC_REFLECT_TYPENAME( surf::protocol::operation )
