...
FC_REFLECT( surf::protocol::shutdown_witness_operation, (owner) )
FC_REFLECT( surf::protocol::hardfork_operation, (hardfork_id) )
FC_REFLECT( surf::protocol::comment_payout_update_operation, (author)(permlink) )
FC_REFLECT( surf::protocol::return_vesting_delegation_operation, (account)(vesting_shares) )
FC_REFLECT( surf::protocol::comment_benefactor_reward_operation, (benefactor)(author)(permlink)(reward) )
FC_REFLECT( surf::protocol::producer_reward_operation, (producer)(vesting_shares) )
