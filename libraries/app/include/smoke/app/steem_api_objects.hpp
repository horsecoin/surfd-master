...
FC_REFLECT( surf::app::comment_api_obj,
             (id)(author)(permlink)
...
FC_REFLECT( surf::app::account_api_obj,
...
FC_REFLECT( surf::app::owner_authority_history_api_obj,
             (id)
             (account)
...
FC_REFLECT( surf::app::account_recovery_request_api_obj,
             (id)
             (account_to_recover)
             (new_owner_authority)
             (expires)
...
FC_REFLECT( surf::app::tag_api_obj,
            (name)
            (total_payouts)
            (net_votes)
            (top_posts)
...
FC_REFLECT( surf::app::witness_api_obj,
             (id)
             (owner)
             (created)
...
FC_REFLECT_DERIVED( surf::app::signed_block_api_obj, (surf::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT_DERIVED( surf::app::dynamic_global_property_api_obj, (surf::chain::dynamic_global_property_object),
