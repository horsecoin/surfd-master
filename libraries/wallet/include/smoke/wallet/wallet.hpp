...
using namespace surf::app;
using namespace surf::chain;
using namespace graphene::utilities;
using namespace std;

namespace surf { namespace wallet {

using surf::app::discussion;
using namespace surf::private_message;
...
class wallet_api
{
   public:
      ...
      /**
       * Transfer funds from one account to another. SURF and SBD can be transferred.
       *
       * @param from The account the funds are coming from
       * @param to The account the funds are going to
       * @param amount The funds being transferred. i.e. "100.000 SURF"
      ...
      /**
       * Transfer funds from one account to another using escrow. SURF and SBD can be transferred.
       *
       * @param from The account the funds are coming from
       * @param to The account the funds are going to
      ...
      /**
       * Transfer SURF into a vesting fund represented by vesting shares (VESTS). VESTS are required to vesting
       * for a minimum of one coin year and can be withdrawn once a week over a two year withdraw period.
       * VESTS are protected against dilution up until 90% of SURF is vesting.
       *
       * @param from The account the SURF is coming from
       * @param to The account getting the VESTS
       * @param amount The amount of SURF to vest i.e. "100.00 SURF"
       * @param broadcast true if you wish to broadcast the transaction
       */
       ...
       *    withdrawn and deposited back as SURF. i.e. "10.000000 VESTS"
       * @param broadcast true if you wish to broadcast the transaction
       */
       ...
       *
       * @param from The account the VESTS are withdrawn from.
       * @param to   The account receiving either VESTS or SURF.
       ...
       *                       operations defined in `surf/chain/operations.hpp`
      ...
      /**
       * Vote on a comment to be paid SURF
       *
...
FC_REFLECT( surf::wallet::wallet_data,
            (cipher_keys)
            (ws_server)
            (ws_user)
            (ws_password)
...
FC_REFLECT( surf::wallet::brain_key_info, (brain_priv_key)(wif_priv_key) (pub_key))

FC_REFLECT( surf::wallet::plain_keys, (checksum)(keys) )

FC_REFLECT_ENUM( surf::wallet::authority_type, (owner)(active)(posting) )

FC_API( surf::wallet::wallet_api,
        /// wallet api
        (help)(gethelp)
...
FC_REFLECT( surf::wallet::memo_data, (from)(to)(nonce)(check)(encrypted) )
