...
FC_REFLECT( surf::chain::transaction_object, (id)(packed_trx)(trx_id)(expiration) )
CHAINBASE_SET_INDEX_TYPE( surf::chain::transaction_object, surf::chain::transaction_index )
