...
namespace surf { namespace chain {
   ...
   class account_object : public object< account_object_type, account_object >
   {
      ...
      public:
         ...
         account_name_type reset_account = SURF_NULL_ACCOUNT;
         ...
         bool              can_vote = true;
         uint16_t          voting_power = SURF_100_PERCENT;   ///< current voting power of this account, it falls after every vote
         ...
         fc::array<share_type, SURF_MAX_PROXY_RECURSION_DEPTH> proxied_vsf_votes;// = std::vector<share_type>( SURF_MAX_PROXY_RECURSION_DEPTH, 0 ); ///< the total VFS votes proxied to this account
...
FC_REFLECT( surf::chain::account_object,
...
CHAINBASE_SET_INDEX_TYPE( surf::chain::account_object, surf::chain::account_index )

FC_REFLECT( surf::chain::account_authority_object,
             (id)(account)(owner)(active)(posting)(last_owner_update)
)
CHAINBASE_SET_INDEX_TYPE( surf::chain::account_authority_object, surf::chain::account_authority_index )

FC_REFLECT( surf::chain::vesting_delegation_object,
            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )
CHAINBASE_SET_INDEX_TYPE( surf::chain::vesting_delegation_object, surf::chain::vesting_delegation_index )

FC_REFLECT( surf::chain::vesting_delegation_expiration_object,
            (id)(delegator)(vesting_shares)(expiration) )
CHAINBASE_SET_INDEX_TYPE( surf::chain::vesting_delegation_expiration_object, surf::chain::vesting_delegation_expiration_index )

FC_REFLECT( surf::chain::owner_authority_history_object,
             (id)(account)(previous_owner_authority)(last_valid_time)
          )
CHAINBASE_SET_INDEX_TYPE( surf::chain::owner_authority_history_object, surf::chain::owner_authority_history_index )

FC_REFLECT( surf::chain::account_recovery_request_object,
             (id)(account_to_recover)(new_owner_authority)(expires)
          )
CHAINBASE_SET_INDEX_TYPE( surf::chain::account_recovery_request_object, surf::chain::account_recovery_request_index )

FC_REFLECT( surf::chain::change_recovery_account_request_object,
             (id)(account_to_recover)(recovery_account)(effective_on)
          )
CHAINBASE_SET_INDEX_TYPE( surf::chain::change_recovery_account_request_object, surf::chain::change_recovery_account_request_index )
