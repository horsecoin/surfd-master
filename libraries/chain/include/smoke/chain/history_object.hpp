...
FC_REFLECT( surf::chain::operation_object, (id)(trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(serialized_op) )
CHAINBASE_SET_INDEX_TYPE( surf::chain::operation_object, surf::chain::operation_index )

FC_REFLECT( surf::chain::account_history_object, (id)(account)(sequence)(op) )
CHAINBASE_SET_INDEX_TYPE( surf::chain::account_history_object, surf::chain::account_history_index )
