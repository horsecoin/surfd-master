...
namespace surf { namespace chain {
   ...
   using surf::protocol::chain_properties;
   using surf::protocol::digest_type;
   using surf::protocol::public_key_type;
   using surf::protocol::version;
   using surf::protocol::hardfork_version;
   ...
   class witness_object : public object< witness_object_type, witness_object >
   {
      ...
      public:
         ...
         time_point_sec    hardfork_time_vote = SURF_GENESIS_TIME;
   };
   ...
   class witness_schedule_object : public object< witness_schedule_object_type, witness_schedule_object >
   {
      public:
         ...
         fc::array< account_name_type, SURF_MAX_WITNESSES >             current_shuffled_witnesses;
         ...
         uint8_t max_voted_witnesses            = SURF_MAX_VOTED_WITNESSES;
         uint8_t max_miner_witnesses            = SURF_MAX_MINER_WITNESSES;
         uint8_t max_runner_witnesses           = SURF_MAX_RUNNER_WITNESSES;
         uint8_t hardfork_required_witnesses    = SURF_HARDFORK_REQUIRED_WITNESSES;
   };
...
FC_REFLECT_ENUM( surf::chain::witness_object::witness_schedule_type, (top19)(timeshare)(miner)(none) )

FC_REFLECT( surf::chain::witness_object,
             (id)
             (owner)
             (created)
...
CHAINBASE_SET_INDEX_TYPE( surf::chain::witness_object, surf::chain::witness_index )

FC_REFLECT( surf::chain::witness_vote_object, (id)(witness)(account) )
CHAINBASE_SET_INDEX_TYPE( surf::chain::witness_vote_object, surf::chain::witness_vote_index )

FC_REFLECT( surf::chain::witness_schedule_object,
...
CHAINBASE_SET_INDEX_TYPE( surf::chain::witness_schedule_object, surf::chain::witness_schedule_index )
