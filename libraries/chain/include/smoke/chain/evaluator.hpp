...
template< typename OperationType=surf::protocol::operation >
class evaluator
{
   public:
...
template< typename EvaluatorType, typename OperationType=surf::protocol::operation >
...
class X ## _evaluator : public surf::chain::evaluator_impl< X ## _evaluator > \
{                                                                           \
   public:                                                                  \
      typedef X ## _operation operation_type;                               \
                                                                            \
      X ## _evaluator( database& db )                                       \
         : surf::chain::evaluator_impl< X ## _evaluator >( db )          \
      {}                                                                    \
                                                                            \
