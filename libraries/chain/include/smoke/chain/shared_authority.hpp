...
namespace surf { namespace chain {
   ...
   using surf::protocol::weight_type;
...
FC_REFLECT_TYPENAME( surf::chain::shared_authority::account_authority_map)
FC_REFLECT( surf::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
