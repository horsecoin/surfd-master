...
class account_statistics_plugin : public surf::app::plugin
{
   public:
...
FC_REFLECT( surf::account_statistics::account_stats_bucket_object,
   (id)
   (open)
   (seconds)
   (name)
...
FC_REFLECT(
   surf::account_statistics::account_activity_bucket_object,
   (id)
   (open)
   (seconds)
