...
#include <surf/protocol/sign_state.hpp>

#include <surf/chain/account_object.hpp>
#include <surf/chain/database.hpp>

#include <surf/plugins/auth_util/auth_util_api.hpp>
#include <surf/plugins/auth_util/auth_util_plugin.hpp>
...
{
   public:
      auth_util_api_impl( surf::app::application& _app );
      void check_authority_signature( const check_authority_signature_params& args, check_authority_signature_result& result );

      std::shared_ptr< surf::plugin::auth_util::auth_util_plugin > get_plugin();

    surf::app::application& app;
};

auth_util_api_impl::auth_util_api_impl( surf::app::application& _app ) : app( _app )
{}

std::shared_ptr< surf::plugin::auth_util::auth_util_plugin > auth_util_api_impl::get_plugin()
{
...
auth_util_api::auth_util_api( const surf::app::api_context& ctx )
{
