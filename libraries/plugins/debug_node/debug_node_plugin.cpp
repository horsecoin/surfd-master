...
)
{
   ...
   surf::chain::public_key_type debug_public_key;
   if( debug_key != "" )
   {
   ...
   surf::chain::database& db = database();
   ...
   while( produced < count )
   {
      ...
      surf::chain::public_key_type scheduled_key = scheduled_witness.signing_key;
      if( debug_key != "" )
      {
...
SURF_DEFINE_PLUGIN( debug_node, surf::plugin::debug_node::debug_node_plugin )
