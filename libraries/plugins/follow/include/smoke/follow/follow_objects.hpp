...
/**
 *  This index is maintained to get an idea of which authors are resurfed by a particular blogger and
 ...
 *  Give me all blog posts by [authors] that were resurfed by this blog
 */
...
FC_REFLECT_ENUM( surf::follow::follow_type, (undefined)(blog)(ignore) )

FC_REFLECT( surf::follow::follow_object, (id)(follower)(following)(what) )
CHAINBASE_SET_INDEX_TYPE( surf::follow::follow_object, surf::follow::follow_index )

FC_REFLECT( surf::follow::feed_object, (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(comment)(reblogs)(account_feed_id) )
CHAINBASE_SET_INDEX_TYPE( surf::follow::feed_object, surf::follow::feed_index )

FC_REFLECT( surf::follow::blog_object, (id)(account)(comment)(reblogged_on)(blog_feed_id) )
CHAINBASE_SET_INDEX_TYPE( surf::follow::blog_object, surf::follow::blog_index )

FC_REFLECT( surf::follow::reputation_object, (id)(account)(reputation) )
CHAINBASE_SET_INDEX_TYPE( surf::follow::reputation_object, surf::follow::reputation_index )

FC_REFLECT( surf::follow::follow_count_object, (id)(account)(follower_count)(following_count) )
CHAINBASE_SET_INDEX_TYPE( surf::follow::follow_count_object, surf::follow::follow_count_index )

FC_REFLECT( surf::follow::blog_author_stats_object, (id)(blogger)(guest)(count) )
CHAINBASE_SET_INDEX_TYPE( surf::follow::blog_author_stats_object, surf::follow::blog_author_stats_index );
