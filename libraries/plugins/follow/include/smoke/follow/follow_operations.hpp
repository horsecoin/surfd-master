...
using namespace std;
using surf::protocol::base_operation;
...
FC_REFLECT( surf::follow::follow_operation, (follower)(following)(what) )
FC_REFLECT( surf::follow::reblog_operation, (account)(author)(permlink) )

DECLARE_OPERATION_TYPE( surf::follow::follow_plugin_operation )

FC_REFLECT_TYPENAME( surf::follow::follow_plugin_operation )
