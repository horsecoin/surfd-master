...
FC_REFLECT( surf::witness::enable_content_editing_operation, (account)(relock_time) )

FC_REFLECT_TYPENAME( surf::witness::witness_plugin_operation )

DECLARE_OPERATION_TYPE( surf::witness::witness_plugin_operation )
