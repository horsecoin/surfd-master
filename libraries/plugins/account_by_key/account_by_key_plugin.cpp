#include <surf/account_by_key/account_by_key_plugin.hpp>
...
account_by_key_plugin::account_by_key_plugin( surf::app::application* app )
...
SURF_DEFINE_PLUGIN( account_by_key, surf::account_by_key::account_by_key_plugin )
