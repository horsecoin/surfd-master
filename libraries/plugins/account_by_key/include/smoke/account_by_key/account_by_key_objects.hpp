...
FC_REFLECT( surf::account_by_key::key_lookup_object, (id)(key)(account) )
CHAINBASE_SET_INDEX_TYPE( surf::account_by_key::key_lookup_object, surf::account_by_key::key_lookup_index )
