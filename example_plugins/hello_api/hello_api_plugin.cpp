...
namespace surf { namespace example_plugin {

class hello_api_plugin : public surf::app::plugin
{
   public:
      /**
       ...
       */
      hello_api_plugin( surf::app::application* app );
...
{
   public:
      hello_api_api( const surf::app::api_context& ctx );
...
FC_API( surf::example_plugin::hello_api_api,
   (get_message)
   )

namespace surf { namespace example_plugin {

hello_api_plugin::hello_api_plugin( surf::app::application* app ) : surf::app::plugin(app) {}
...
hello_api_api::hello_api_api( const surf::app::api_context& ctx ) : _app(ctx.app) {}
...
/**
 * The SURF_DEFINE_PLUGIN() macro will define a surf::plugin::create_hello_api_plugin()
 * factory method which is expected by the manifest.
 */

SURF_DEFINE_PLUGIN( hello_api, surf::example_plugin::hello_api_plugin )
