...
operation_tests      // Unit Tests of Surf operations
operation_time_tests // Tests of Surf operations that include a time based component (ex. vesting withdrawals)
...
```
cmake -D BUILD_SURF_TESTNET=ON -D ENABLE_COVERAGE_TESTING=true -D CMAKE_BUILD_TYPE=Debug .
make
