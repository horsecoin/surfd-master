...
# local imports
from surfddebugnode import DebugNode
...
def main( ):
   ...
   parser = ArgumentParser( description='Run a surfd debug node on an existing chain, trigger a hardfork' \
...
def run_surfd_tests( debug_node ):
   from surfapi.surfnoderpc import SurfNodeRPC
